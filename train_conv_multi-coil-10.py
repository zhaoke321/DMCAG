...
#   train_conv_multi-coil-10.py 中完全相同或高度相似
...
# [DUPLICATE] ClusteringLayer: 3 个训练文件中完全相同，建议移入 utils.py
...
# ============================================================
# [DUPLICATE BLOCK START] 以下函数在 3 个训练文件中完全相同
# 建议全部移入 utils.py
# ============================================================

# [DUPLICATE] 独立版 computegcn
def computegcn(z, Af):
    D = torch.sum(Af, dim=1)
    D = 1 / D
    D = torch.sqrt(D)
...
# [PARTIAL-DUPLICATE] pretrain_aes: 3 个训练文件 ~70% 相同（本文件中评估代码未注释）
def pretrain_aes():
    ...
    print(f"[pretrain] dataset={args.dataset} arch={args.arch} "
...
# ============================================================
# [DUPLICATE BLOCK] 对比学习函数，3 个训练文件完全相同
# ============================================================
