...
# [DUPLICATE] multiViewDataset2 与 imagedataset 代码 95% 相同
# 唯一差异：第 24 行 viewNumber>=2 vs 第 56 行 viewNumber>=6（MinMaxScaler 阈值）
# 建议：合并为带参数的单一类
...
# [DUPLICATE] 与 multiViewDataset2 几乎完全相同（仅 MinMaxScaler 阈值不同）
